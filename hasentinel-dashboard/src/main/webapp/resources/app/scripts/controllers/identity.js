...
app.controller('IdentityCtl', ['$scope', '$stateParams', 'IdentityService',
  'ngDialog', 'FlowServiceV2', 'DegradeService', 'AuthorityRuleServiceV2', 'ParamFlowService', 'MachineService',
  '$interval', '$location', '$timeout',
  function ($scope, $stateParams, IdentityService, ngDialog,
    FlowServiceV2, DegradeService, AuthorityRuleServiceV2, ParamFlowService, MachineService, $interval, $location, $timeout) {
