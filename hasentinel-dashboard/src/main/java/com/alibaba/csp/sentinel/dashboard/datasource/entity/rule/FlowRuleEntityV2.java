...
public class FlowRuleEntityV2 {
	...
	public static FlowRuleEntityV2 fromFlowRule(String app, String ip, Integer port, FlowRule rule) {
		FlowRuleEntityV2 entity = new FlowRuleEntityV2();
		entity.setApp(app);
		entity.setIp(ip);
		entity.setPort(port);
	...
	public FlowRuleEntityV2 setClusterMode(boolean clusterMode) {
	...
	public FlowRuleEntityV2 setClusterConfig(ClusterFlowConfig clusterConfig) {
