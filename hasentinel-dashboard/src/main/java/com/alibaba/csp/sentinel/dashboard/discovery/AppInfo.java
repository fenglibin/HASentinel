...
public class AppInfo {
	 ...
	 * displayed.
	 *
	 * @return true if the application should be displayed in the sidebar, otherwise
	 *         false
	 */
	...
	/**
	 * Check whether current application has no healthy machines and should be
	 * removed.
	 *
	 * @return true if the application is dead and should be removed, otherwise
	 *         false
	 */
