...
import com.alibaba.csp.sentinel.dashboard.datasource.entity.rule.DegradeRuleEntityV2;
import com.alibaba.csp.sentinel.dashboard.discovery.MachineInfo;
import com.alibaba.csp.sentinel.dashboard.domain.Result;
import com.alibaba.csp.sentinel.dashboard.rule.zookeeper.degrade.ZookeeperDegradeRuleStore;
...
public class DegradeControllerV2 {
	...
	@Autowired
	private ZookeeperDegradeRuleStore<DegradeRuleEntity> repository;
	@Autowired
	...
	public Result<List<DegradeRuleEntityV2>> queryRules(String app, String ip, Integer port) {
		...
		try {
			...
			if (rules != null && rules.size() > 0) {
				rules.forEach(r -> {
					list.add(r.getDegradeRuleEntityV2());
				});
			}
	...
	@AuthAction(PrivilegeType.WRITE_RULE)
	public Result<DegradeRuleEntityV2> add(String app, String ip, Integer port, String limitApp, String resource,
		...
		return Result.ofSuccess(entity.getDegradeRuleEntityV2());
	}
	...
	@AuthAction(PrivilegeType.WRITE_RULE)
	public Result<DegradeRuleEntityV2> updateIfNotNull(Long id, String app, String limitApp, String resource,
			Double count, Integer timeWindow, Integer grade) {
		if (id == null) {
			return Result.ofFail(-1, "id can't be null");
		}
	...
	@AuthAction(PrivilegeType.DELETE_RULE)
	public Result<Long> delete0(Long id) {
		if (id == null) {
			return Result.ofFail(-1, "id can't be null");
		}
