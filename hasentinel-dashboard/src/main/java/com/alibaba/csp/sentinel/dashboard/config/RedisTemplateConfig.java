...
import com.alibaba.csp.sentinel.dashboard.config.RedisConfig.LettucePoolConfig;
...
@Configuration
@EnableCaching
@EnableConfigurationProperties({ RedisConfig.class, LettucePoolConfig.class, CacheTimeConfig.class})
@Slf4j
