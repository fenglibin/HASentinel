 ...
 * @author leyou
 */
public class SystemRuleEntityV2 {
	...
	public static SystemRuleEntityV2 fromSystemRule(String app, String ip, Integer port, SystemRule rule) {
		SystemRuleEntityV2 entity = new SystemRuleEntityV2();
		entity.setApp(app);
		entity.setIp(ip);
		entity.setPort(port);
