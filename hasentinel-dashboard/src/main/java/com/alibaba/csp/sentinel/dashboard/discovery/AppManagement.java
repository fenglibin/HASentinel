...
import com.alibaba.csp.sentinel.dashboard.discovery.zookeeper.ZookeeperMachineDiscovery;
...
public class AppManagement implements MachineDiscovery {
	...
	public void init() {
		...
		machineDiscovery = context.getBean(ZookeeperMachineDiscovery.class);
	}
